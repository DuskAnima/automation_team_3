package cl.kibernumacademy.login;
...
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "cl.kibernumacademy.login.steps") // Indicar donde estan los steps definitions
